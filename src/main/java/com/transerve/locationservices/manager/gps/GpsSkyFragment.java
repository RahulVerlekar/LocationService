...
import com.transerve.locationservices.manager.gps.view.GpsSkyView;
...
public class GpsSkyFragment extends Fragment implements GpsTestListener {
    ...
    private void updateSnrCn0Avgs() {
        ...
        int meterWidthPx = (int) getResources().getDimension(R.dimen.cn0_meter_width)
                - UIUtils.dpToPixels(getContext(), 7.0f); // Reduce width for padding
        int minIndicatorMarginPx = (int) getResources().getDimension(R.dimen.cn0_indicator_min_left_margin);
        int maxIndicatorMarginPx = meterWidthPx + minIndicatorMarginPx;
        int minTextViewMarginPx = (int) getResources().getDimension(R.dimen.cn0_textview_min_left_margin);
        ...
        if (leftInViewTextViewMarginPx != null && leftUsedTextViewMarginPx != null) {
            int offset = UIUtils.dpToPixels(getContext(), TEXTVIEW_NON_OVERLAP_OFFSET_DP);
        ...
        int pSides = UIUtils.dpToPixels(getContext(), 7);
        int pTopBottom = UIUtils.dpToPixels(getContext(), 4);
        ...
        if (MathUtils.isValidFloat(mSkyView.getSnrCn0InViewAvg())) {
            ...
            LayerDrawable background = (LayerDrawable) ContextCompat.getDrawable(getContext(), R.drawable.cn0_round_corner_background_in_view);
        ...
        if (MathUtils.isValidFloat(mSkyView.getSnrCn0UsedAvg())) {
            ...
            LayerDrawable background = (LayerDrawable) ContextCompat.getDrawable(getContext(), R.drawable.cn0_round_corner_background_used);
