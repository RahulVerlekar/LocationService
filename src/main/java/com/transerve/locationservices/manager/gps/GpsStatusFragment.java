...
import com.transerve.locationservices.manager.gps.model.ConstellationType;
import com.transerve.locationservices.manager.gps.model.GnssType;
import com.transerve.locationservices.manager.gps.model.SatelliteStatus;
...
import com.transerve.locationservices.manager.gps.util.SortUtil;
import com.transerve.locationservices.manager.gps.util.UIUtils;
...
import static com.transerve.locationservices.manager.gps.model.GnssType.SBAS;
...
public class GpsStatusFragment extends Fragment implements GpsTestListener {
    ...
    private String METERS_PER_SECOND;
    ...
    private void setupConstants() {
        METERS = mRes.getString(R.string.preferences_preferred_distance_units_option_meters);
        METERS_PER_SECOND = mRes.getString(R.string.preferences_preferred_speed_units_option_meters_per_second);
        KILOMETERS_PER_HOUR = mRes.getString(R.string.preferences_preferred_speed_units_option_kilometers_per_hour);
    }
...
//        setStarted(gta.mStarted);
    ...
    public void onLocationChanged(Location location) {
        ...
        boolean showDMS = getPrefs().getBoolean(getString(R.string.pref_key_dms_mode), false);
        if (showDMS) {
            mLatitudeView.setText(UIUtils.getDMSFromLocation(getContext(), location.getLatitude()));
            mLongitudeView.setText(UIUtils.getDMSFromLocation(getContext(), location.getLongitude()));
        } else {
    ...
    private void sortLists() {
        final int sortBy = new PreferenceUtils(getActivity()).getSatSortOrderFromPreferences();
    ...
    private void setupUnitPreferences() {
        ...
        mPrefDistanceUnits = settings
                .getString(getString(R.string.pref_key_preferred_distance_units), METERS);
        mPrefSpeedUnits = settings
                .getString(getString(R.string.pref_key_preferred_speed_units), METERS_PER_SECOND);
    }
    ...
    private void showSortByDialog() {
        ...
        final int currentSatOrder = new PreferenceUtils(getActivity()).getSatSortOrderFromPreferences();
    ...
    private void setSortByClause(int index) {
        ...
        new PreferenceUtils(getActivity()).saveString(getResources()
    ...
    public void attachAvtivity(ActivityCallbackProvider activityCallbackProvider) {
